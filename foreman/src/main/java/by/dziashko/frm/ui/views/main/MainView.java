...
import by.dziashko.frm.ui.views.order.OrderNameView;
...
public class MainView extends AppLayout {
    ...
    private Component[] createMenuItems() {
        RouterLink[] links = new RouterLink[] {
            new RouterLink("Sellers List", SellersListView.class),
            new RouterLink("Order", OrderNameView.class)
        };
